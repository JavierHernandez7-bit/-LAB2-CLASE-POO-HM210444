...
namespace ejercicio2Guia2
{
    public partial class Form1 : Form
    {
        ...
        {
            double n1, n2, r; n1 = Convert.ToDouble(txtnum1.Text); n2 = Convert.ToDouble(txtnum2.Text);
            ...
            {
                if (listadvance.SelectedItem.ToString() == "Multiplicacion") r = n1 * n2; else r = n1 / n2;
                MessageBox.Show("El Resultado es " + r.ToString(), "Respuesta");
            }
        }
